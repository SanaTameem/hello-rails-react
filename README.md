...
```sh
  cd my-folder
  git clone https://github.com/SanaTameem/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/SanaTameem/hello-rails-react/issues).
...
This project is [MIT](https://github.com/SanaTameem/hello-rails-react/blob/feature/project-setup/MIT.md) licensed.
